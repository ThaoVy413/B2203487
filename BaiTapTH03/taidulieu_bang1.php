...
$sql = "SELECT student.id,student.fullname,student.email,student.Birthday,student.major_id, major.name_major  FROM STUDENT JOIN MAJOR ON STUDENT.major_id = major.id";
...
<tr>
    ...
    <th>Major ID</th>
    <th>Major Name</th>
    <td colspan="2"><strong>Hanh dong</strong></td>
<?php
