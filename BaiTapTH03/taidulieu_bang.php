...
$result -> free_result();
// Cách 5
echo "<h3>Sử dụng fetch_object()</h3>";
$result = $conn->query($sql);
...
$result -> free_result();
// Cách 6
echo "<h3>Sử dụng fetch_array()</h3>";
$result = $conn->query($sql);
while ($row = $result->fetch_array()) {
    echo "ID: " . $row['id'] . " - Họ tên: " . $row['fullname'] . " - Email: " . $row[2] . " - Ngày sinh: " . $row[3] . "<br>";
}
}
 else {
